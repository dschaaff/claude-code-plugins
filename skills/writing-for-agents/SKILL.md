...
description: Writing documents an agent reads. Use when creating or editing a skill, or modifying AGENTS.md or CLAUDE.md.
---
...
_Adapted from [mattpocock/skills](https://github.com/mattpocock/skills) `productivity/writing-for-agents`._
